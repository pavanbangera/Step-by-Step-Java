...
public class Recursions {
    ...
    public static void printCombi(String str, int index, String combination) {
        if (index == str.length()) {
        ...
        for (int i = 0; i < mapping.length(); i++) {
            printCombi(str, index + 1, combination + mapping.charAt(i));
        }
    ...
    public static int countPaths(int i, int j, int n, int m) {
        ...
        int countDown = countPaths(i, j + 1, n, m);

        int countRight = countPaths(i + 1, j, n, m);
